...
if model is not None:
    ...
    st.markdown("The chart below displays the number of patients waiting for different elective treatments over time. The vertical axis is in logarithmic scale to better visualize the changes in patient numbers for different waiting time categories.")
